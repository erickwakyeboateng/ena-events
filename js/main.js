...
// Timer
// Set the target date
const targetDate = new Date('September 8, 2024 09:00:00').getTime();
...
const timerInterval = setInterval(function() {
	...
	// If the countdown is finished, trigger event program download
	if (distance < 0) {
...
document.getElementById('download-btn').addEventListener('click', function() {
	...
	link.href = 'event-program.pdf'; // Update with actual file URL
	link.download = 'event-program.pdf';
	link.click();
});